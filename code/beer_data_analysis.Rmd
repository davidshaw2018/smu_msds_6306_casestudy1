...
Therefore, we will do our mean imputation by state. 
...
After imputation, we now want to see the median alochol by volume and the median bitterness of beers produced in each state. 
